...
#define INTEL_GEN6_4_SLICE // #define INTEL_GEN6_ALTERNATE
...
#define L2_CANDIDATE_SIZE_TARGET (L1D_ASSOCIATIVITY + L2_ASSOCIATIVITY) // Skylake
...
#define LLC_EVSET_ALGORITHM GROUP_TESTING_OPTIMISED_NEW
